...
import com.busanit501.lhslunchproject.service.LunchService;
...
public class LunchController {
    ...
    public void list(PageRequestDTO pageRequestDTO, Model model) {
        ...
        log.info("BoardController : /lunch/list  확인 중, pageRequestDTO : " + pageRequestDTO);
    ...
    ,PageRequestDTO pageRequestDTO) {
        ...
        if(bindingResult.hasErrors()) {
            ...
            // 서버 -> 화면으로 쿼리 스트링으로전달.
            // 예시 : ?bno=게시글번호
            redirectAttributes.addAttribute("bno", lunchDTO.getBno());
        ...
        // 글쓰기 후, 작성된 게시글 번호 -> 화면 , 임시로 전달.(1회용)
        redirectAttributes.addFlashAttribute("result",lunchDTO.getBno());
